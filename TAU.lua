...
usertext = '\n👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(username or 'TEAMTAU')..')'
...
usertext = '\n👤┇العضو ~⪼ ['..data.first_name_..'](t.me/'..(data.username_ or 'TEAMTAU')..')'
status  = '\n📬┇تم ترقيته مطور في البوت'
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤┇بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'TEAMTAU')..') \n🔘┇تـم قفـل التاك بالكتم ')  
end,nil)   
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤┇العضو ~⪼ ['..result.title_..'](t.me/'..(text1[3] or 'TEAMTAU')..')'..'\n📬┇تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
