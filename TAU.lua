...
usertext = '\n💁🏻‍♂️| المستخدم ✓ ['..result.title_..'](t.me/'..(username or 'TAU')..')'
...
usertext = '\n💁🏻‍♂️| المستخدم ✓ ['..data.first_name_..'](t.me/'..(data.username_ or 'TAUTEAM')..')'
status  = '\n✔| تم رفعه مطور في البوت'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n💁🏻‍♂️| المستخدم ✓ ['..result.title_..'](t.me/'..(text1[3] or 'TAU')..')'..'\n📬| تم رفعهہ‌‏ '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
